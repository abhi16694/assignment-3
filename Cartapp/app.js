...
var dbPath  = "mongodb://localhost/myCart";
...
//set the middleware as app level
app.use(setLoggedInUser = function(req,res,next){
...
app.listen(3000, function () {
  console.log('Cart app listening on port 3000!');
});